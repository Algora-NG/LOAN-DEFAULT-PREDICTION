...
def load_model():
	model = joblib.load(r"C:\Users\HP\Desktop\streanlit\final_lr_model (1).pkl")
	return model

@st.cache_resource(show_spinner = "Loading scaler")
def load_scaler():
	scaler = joblib.load(r"C:\Users\HP\Desktop\streanlit\lr_scaler (1).pkl")
	return scaler

@st.cache_resource(show_spinner = "Loading col")
def load_col():
	col_name  = joblib.load(r"C:\Users\HP\Desktop\streanlit\col_name.pkl")
	return col_name
